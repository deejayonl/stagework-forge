...
const CodeEditor: React.FC<CodeEditorProps> = ({ value, language, onChange }) => {
  ...
  return (
    <div className="relative w-full h-full bg-transparent overflow-hidden group p-4 md:p-6">
      <div className="relative w-full h-full">
        ...
        <textarea
            ...
            className="absolute inset-0 w-full h-full font-mono text-sm leading-6 bg-transparent text-transparent caret-accent resize-none border-none outline-none z-10 whitespace-pre overflow-auto"
            spellCheck="false"
            autoCapitalize="off"
            autoComplete="off"
            autoCorrect="off"
        ...
        <pre
            ref={preRef}
            className={`absolute inset-0 w-full h-full font-mono text-sm leading-6 m-0 bg-transparent text-ink pointer-events-none z-0 overflow-hidden whitespace-pre language-${prismLang}`}
        >
