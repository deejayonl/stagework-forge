      ...
      <div className="p-4 flex flex-col gap-4">
        ...
        <div className="space-y-3">
          ...
          <p className="text-[9px] text-hall-500 leading-tight">
            Actions: <code className="bg-hall-100 dark:bg-hall-900 px-1 py-0.5 rounded">setVariable:key:value</code>, <code className="bg-hall-100 dark:bg-hall-900 px-1 py-0.5 rounded">toggleVariable:key</code>, <code className="bg-hall-100 dark:bg-hall-900 px-1 py-0.5 rounded">alert:message</code>
          </p>
        </div>
