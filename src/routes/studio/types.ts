...
export type NodeType = 'text' | 'code' | 'image' | 'video' | 'website' | 'terminal' | 'api' | 'condition' | 'loop' | 'delay' | 'merge' | 'log' | 'sticky' | 'group';
...
export interface CanvasNode {
    ...
    parentId?: string; // ID of the group node this belongs to
}
