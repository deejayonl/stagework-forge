...
import { BFFProvider } from "./providers/bff";
...
class AIOrchestrator {
    ...
    constructor() {
        // Switch to BFFProvider to wire up the Go backend
        this.provider = new BFFProvider();
    }
    ...
    async *streamResponse(agentId: AgentId, prompt: string, history: any[], isArtifactMode = false, _artifactLanguage = '', imageContext?: string) {
