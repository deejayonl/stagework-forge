            ...
            <div className="space-y-1.5">
                ...
                <div className="bg-bg-surface/50 border border-border-subtle rounded-xl overflow-hidden">
                    ...
                    <ToggleRow 
                        label="Step Routing" 
                        icon="route" 
                        active={useStepRouting} 
                        onClick={onToggleStepRouting} 
                    />
                    <Divider />
                    <ToggleRow 
                        label="Chat Overlay" 
                ...
                <div className="bg-bg-surface/50 border border-border-subtle rounded-xl overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-3 py-2.5">
                        <div className="flex items-center gap-3">
                            <div className="w-6 h-6 rounded-xl flex items-center justify-center bg-emerald-500/10 text-emerald-500">
