    ...
    <div className="h-full w-full flex flex-col bg-bg-surface border-l border-border-subtle animate-in-slide">
      ...
      <div className="h-14 border-b border-border-subtle flex items-center justify-between px-6 bg-bg-main/50 backdrop-blur">
        ...
        <div className="flex items-center gap-2">
            <button className="w-8 h-8 flex items-center justify-center rounded-2xl hover:bg-border-subtle text-text-secondary transition-colors" title="Download/Copy">
                <i className={`fa-solid ${item.type === 'code' ? 'fa-copy' : 'fa-download'}`}></i>
            </button>
            <button onClick={onClose} className="w-8 h-8 flex items-center justify-center rounded-2xl hover:bg-border-subtle text-text-secondary transition-colors">
