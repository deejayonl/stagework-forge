...
export const AGENTS: Record<AgentId, Agent> = {
  [AgentId.FORGE]: {
    ...
    systemInstruction: `
You are **Forge**, the central orchestrator of this multi-agent system.
...
`
  ...
  [AgentId.PRO]: {
    ...
    systemInstruction: `
You are **ProForge**, the system’s high-precision reasoning engine.  
...
`
  ...
  [AgentId.CODE]: {
    ...
    systemInstruction: `
You are **CodeForge**, an elite software engineer, architect, debugger, and system designer.
...
`
  ...
  [AgentId.CREATIVE]: {
    ...
    systemInstruction: `
You are **CreativeForge**, the system’s creative studio.  
...
`
  ...
  [AgentId.IMAGE]: {
    ...
    systemInstruction: `
You are **ImageForge**, a visual-generation agent.  
...
`
  ...
  [AgentId.VIDEO]: {
    ...
    systemInstruction: `
You are **VideoForge**, the motion-generation agent.  
...
`
  ...
  [AgentId.LIVE]: {
    ...
    systemInstruction: `
You are **LiveForge**, a real-time conversational voice agent.  
